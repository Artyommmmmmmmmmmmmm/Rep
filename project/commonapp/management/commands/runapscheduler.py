...
from commonapp.signals import New_created, Article_created
from commonapp.models import Category, Article, New, Subscription
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            my_job,
            trigger=CronTrigger(day_of_week="thu", hour="09", minute="48"),  # Every 10 seconds
